 ...
 */
public class ReportByYear extends ArrayAdapter<fr.deepanse.soywod.deepanse.model.Report>
{
    public ReportByYear(Context context, ArrayList<fr.deepanse.soywod.deepanse.model.Report> report) {
