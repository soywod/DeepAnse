 ...
 */
public class ListViewDeepAnseGroup extends ArrayAdapter<fr.deepanse.soywod.deepanse.model.DeepAnseGroup>
{
    public ListViewDeepAnseGroup(Context context, ArrayList<fr.deepanse.soywod.deepanse.model.DeepAnseGroup> arrayDeepAnseGroup) {
